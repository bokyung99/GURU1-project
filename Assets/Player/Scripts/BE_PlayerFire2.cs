...
public class BE_PlayerFire2 : MonoBehaviour
{
    ...
    void UpdateA()
    {
        ...
        {
            //소지 수류탄이 있을 때
            if (GameObject.Find("Player").GetComponent<BE_PlayerFire>().BombbearCount > 0)
            {
                //수류탄 하나 사용
                GameObject.Find("Player").GetComponent<BE_PlayerFire>().BombbearCount--;
    ...
    void UpdateB()
    {
        ...
        string BbC = GameObject.Find("Player").GetComponent<BE_PlayerFire>().BombbearCount.ToString();
